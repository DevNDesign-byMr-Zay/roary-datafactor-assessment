/* Aster JavaScript v219 — authenticated buyer-safe derivative: restore-only-when-empty thread backup recovery. Host state/dependencies are intentionally external. */
